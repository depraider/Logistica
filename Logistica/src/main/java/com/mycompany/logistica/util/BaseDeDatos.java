...
public class BaseDeDatos {
    ...
    // Datos del servidor (nota: sin especificar la BD)
    ...
    // Crea las tablas necesarias dentro de la base de datos
    private static void crearTablasSiNoExisten() throws SQLException {
        String urlDB = URL_BASE + DB_NAME;
        try (Connection con = DriverManager.getConnection(urlDB, USER, PASSWORD);
             Statement st = con.createStatement()) {
